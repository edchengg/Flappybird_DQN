...
def TrainFlappyBird(dueling_Q = False):
    ...
    num_actions = 2
    AI_player = DQN_AI(num_actions = num_actions, mode = 'train', dueling_Q = dueling_Q)
...
def TestFlappyBird(video_record = True, dueling_Q = False):
    ...
    num_actions = 2
    AI_player = DQN_AI(num_actions = num_actions, mode = 'test', dueling_Q = dueling_Q)
...
def TrainFlappyBirdResume(dueling_q = False):
...
def main():
    ...
    parser.add_argument('-n','--net', help='Vanilla_Q / Dueling_Q ', required=True)
    args = vars(parser.parse_args())

    if args['mode'] == 'train':
        if args['net'] == 'Vanilla_Q':
            TrainFlappyBird()
        elif args['net'] == 'Dueling_Q':
            TrainFlappyBird(True)
    elif args['mode'] == 'test':
        if args['net'] == 'Vanilla_Q':
            TestFlappyBird()
        elif args['net'] == 'Dueling_Q':
